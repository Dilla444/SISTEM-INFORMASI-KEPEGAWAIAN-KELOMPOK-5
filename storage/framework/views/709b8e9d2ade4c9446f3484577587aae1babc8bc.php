...
<div class="container-fluid">
  ...
  <div class="table-responsive">
                ...
                <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0"> 
                  ...
                  <tbody>
                  <?php $__currentLoopData = $gapok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr role="row" class="odd">
                  <td><?php echo e($agm->kode_gapok); ?></td>
                  <td><?php echo e($agm->masa_kerja); ?></td>
                  <td><?php echo e($agm->PP); ?></td>
                  <td><?php echo e($agm->kode_gol); ?></td>
                  <td><?php echo e($agm->gapok); ?></td>
                  <td>
                    <!-- Button trigger modal -->
                    <!-- Button trigger modal -->
                    <a href="/pegawai/tmgapok/hapus/<?php echo e($agm->kode_gapok); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
...
<?php echo $__env->make('layouts.induk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp b\htdocs\semester 5\sistem-informasi-kepegawaian-8\resources\views/tm/gapok.blade.php ENDPATH**/ ?>