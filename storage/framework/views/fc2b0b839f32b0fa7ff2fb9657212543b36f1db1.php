...
<head>
  ...
  <link href="<?php echo e(asset ('/adminpix/base.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset ('/adminpix/export.css')); ?>" rel="stylesheet" type="text/css">

  <link href="<?php echo e(asset ('/adminpix/style.css')); ?>" rel="stylesheet" type="text/css">
...
$(document).ready(function(){
  ...
  <script src="<?php echo e(asset ('/sbadmin/js/demo/chart-bar-demo.js')); ?>"></script>
  <script src="<?php echo e(asset ('/sbadmin/js/demo/datatables-demo.js')); ?>"></script>


  <!-- START CORE PLUGINS -->
  <!-- <script src="<?php echo e(asset ('adminpix/jquery-slimscroll.js')); ?>"></script>
        <script src="<?php echo e(asset ('adminpix/plugins/fastclick/fastclick.js')); ?>"></script>
        <script src="<?php echo e(asset ('adminpix/plugins/metisMenu/metismenu.js')); ?>"></script>
        <script src="<?php echo e(asset ('adminpix/plugins/lobipanel/lobipanel.js')); ?>"></script> -->
  <!-- Amcharts Js -->

  <!-- START THEME LABEL SCRIPT -->
  <!-- <script src="<?php echo e(asset ('adminpix/theme.js')); ?>"></script> -->

  <?php echo $__env->make('sweetalert::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

</body>

</html><?php /**PATH C:\xampp b\htdocs\semester 5\sistem-informasi-kepegawaian-8\resources\views/layouts/induk.blade.php ENDPATH**/ ?>